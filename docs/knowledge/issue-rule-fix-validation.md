...
| `IMAGE.LOW_EFFECTIVE_DPI` | Placement DPI below threshold | Replace or enhance | Original fact retained + output QA |
| `PAGE.BLEED_INSUFFICIENT` | Minimum 3 mm | Solid extend / confirm / manual | Explicit box + edge coverage + preview |
